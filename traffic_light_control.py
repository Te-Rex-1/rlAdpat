...
def record_vehicle_queue(step, filename="queue_log.txt"):
    # Get the halting numbers for each edge (adjust edge IDs as needed)
    queue_count = (
    ...
    # Append the step and queue count to the log file
